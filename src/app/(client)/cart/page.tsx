          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      ...
                      <th className="py-4 px-4 text-center text-sm font-medium text-gray-700 hidden sm:table-cell">
                        Price
                      </th>
                      <th className="py-4 px-4 text-center text-sm font-medium text-gray-700">
                        Quantity
                      </th>
                      <th className="py-4 px-4 text-right text-sm font-medium text-gray-700 hidden sm:table-cell">
                        Subtotal
                      </th>
                      ...
                      return (
                        <tr key={item.variantId} className="border-b">
                          ...
                          <td className="py-4 px-4">
                            <div className="flex items-center">
                              ...
                              <div>
                                ...
                                {/* Mobile price */}
                                <div className="mt-1 sm:hidden text-sm font-medium">
                                  ${price?.toFixed(2)}
                                </div>
                              </div>
                            </div>
                          ...
                          <td className="py-4 px-4">
                            ...
                            {/* Mobile subtotal */}
                            <div className="mt-2 text-center sm:hidden text-sm font-medium">
                              ${subtotal?.toFixed(2)}
                            </div>
                          </td>

                          {/* Subtotal */}
                          <td className="py-4 px-4 text-right text-gray-900 font-medium hidden sm:table-cell">
                            ${subtotal?.toFixed(2)}
                          </td>
              ...
              <div className="flex flex-wrap justify-between items-center mt-6 gap-4">
                <Button
                  variant="outline"
                  onClick={() => router.push("/category/short-sleeve")}
