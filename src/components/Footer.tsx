  ...
  return (
    <footer className="bg-brand-950 text-white py-12">
      <div className="container-custom">
        ...
        <div className="border-t border-brand-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-brand-400 text-sm">
            &copy; {new Date().getFullYear()} Sartorial. All rights reserved.
          </p>
